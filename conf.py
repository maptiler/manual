...
project = u'MapTiler Engine Manual'
copyright = u'2010 - 2020, MapTiler Team, Klokan Technologies GmbH'
...
htmlhelp_basename = 'MapTilerManualdoc'
...
latex_documents = [
  (
    'index',
    'MapTilerManual.tex',
    u'MapTiler Manual Documentation',
